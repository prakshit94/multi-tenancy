...
class ProductTypeController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('tenant.product_types.index', compact('productTypes'));
    }

    public function create(): View
    {
        $this->authorize('products create');
        return view('tenant.product_types.create');
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            return redirect()->route('tenant.product_types.index')
    ...
    public function edit(ProductType $productType): View
    {
        ...
        return view('tenant.product_types.edit', compact('productType'));
    }
