...
class OrderReturnController extends Controller
{
    ...
    public function bulkUpload(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            if (count($errors) > 0) {
                return redirect()->route('central.returns.index')->with('warning', "Created $createdCount RMAs. Some errors occurred: " . implode(', ', $errors));
            }

            return redirect()->route('central.returns.index')->with('success', "Successfully created $createdCount bulk RMA requests.");
