                                                ...
                                                <div>
                                                    <div class="text-xs font-bold text-foreground">
                                                        ...
                                                        @if($onlineUser->id === auth()->id())
                                                            <span
                                                                class="text-[9px] uppercase tracking-widest text-primary ml-1">(You)</span>
                                                        @endif
                                                    </div>
                                            ...
                                            <td class="px-6 py-5">
                                                <div class="flex flex-col">
                                                    ...
                                                    <span
                                                        ...
                                                        {{ ($order->placed_at ?? $order->created_at)->format('H:i') }}
                                                    </span>
                                                </div>
                                            </td>
                                            <td class="px-6 py-5">
                                    ...
                                    <div class="flex justify-between items-start mb-4">
                                        ...
                                        <div class="text-right">
                                            ...
                                            <p class="text-[10px] font-bold text-muted-foreground">
                                                {{ ($order->placed_at ?? $order->created_at)->format('M d, H:i') }}
                                            </p>
                                        </div>
                                    </div>
