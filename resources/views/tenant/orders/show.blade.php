                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-center gap-6 mt-8 p-6 bg-gray-50/50 rounded-2xl border border-gray-100" x-data="{ showShipModal: false, courier: '', trackingNumber: '' }">
                        <div class="flex items-center gap-3 w-full md:w-auto">
                            ...
                            <!-- Print Actions -->
                            <div class="flex items-center gap-2 border-l border-gray-200 pl-3" x-data="{}">
                                <a href="{{ route('tenant.orders.invoice', $order) }}" 
                                   @click="$dispatch('notify', { type: 'success', message: 'Invoice download started' })"
                                   class="text-gray-400 hover:text-gray-600 transition p-2 hover:bg-gray-100 rounded-lg" title="Print Invoice">
                                ...
                                <a href="{{ route('tenant.orders.receipt', $order) }}" 
                                   ...
                                   class="text-gray-400 hover:text-gray-600 transition p-2 hover:bg-gray-100 rounded-lg" title="Print COD Receipt">
