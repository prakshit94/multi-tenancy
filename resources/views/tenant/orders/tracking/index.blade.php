    ...
    <div id="tracking-page-wrapper"
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
            ...
            <div
                ...
                <a href="{{ route('tenant.orders.tracking.index', ['status' => 'shipped']) }}"
                ...
                <a href="{{ route('tenant.orders.tracking.index', ['status' => 'attempt_failed']) }}"
                ...
                <a href="{{ route('tenant.orders.tracking.index', ['status' => 'delivered']) }}"
                ...
                <a href="{{ route('tenant.orders.tracking.index', ['status' => 'all']) }}"
