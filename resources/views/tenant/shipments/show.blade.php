             ...
             <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="border-t pt-4 flex justify-between items-center">
                        <a href="{{ route('tenant.shipments.index') }}" class="text-gray-500 hover:underline">&larr; Back to Shipments</a>

                        @if($shipment->status !== 'delivered')
                            <form action="{{ route('tenant.shipments.update-status', $shipment) }}" method="POST">
                                @csrf @method('PATCH')
