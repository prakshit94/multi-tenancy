                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden min-h-[500px]">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-8">
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-2 flex items-center">
                                            ...
                                            <input type="checkbox" name="is_sku_enabled" value="1" id="is_sku_enabled" {{ old('is_sku_enabled', 1) ? 'checked' : '' }}
                                    ...
                                    <div class="col-span-1 md:col-span-2 shadow-sm p-4 bg-gray-50 rounded-xl border border-gray-100/50">
                                        ...
                                        <textarea name="description" rows="4" 
                                            ...
                                            placeholder="Write a clear, compelling description of the product...">{{ old('description') }}</textarea>
                            ...
                            <div x-show="tab === 'pricing'" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 translate-y-2" x-transition:enter-end="opacity-100 translate-y-0" class="p-6 sm:p-8 space-y-8" style="display: none;">
                                ...
                                <div class="border-t border-gray-100 pt-6">
                                    ...
                                    <div x-data="{ allowOversell: {{ old('allow_oversell') ? 'true' : 'false' }} }" class="mb-6 bg-gray-50 p-4 rounded-xl border border-gray-100">
                                        <div class="flex items-center space-x-3 mb-4">
                                            <input type="hidden" name="allow_oversell" value="0">
                                            <input type="checkbox" name="allow_oversell" id="allow_oversell" value="1" x-model="allowOversell" {{ old('allow_oversell') ? 'checked' : '' }}
                                                class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
                                        ...
                                        <div x-show="allowOversell" x-transition class="mt-2 ml-7">
                                            ...
                                            <input type="number" step="1" name="oversell_limit" value="{{ old('oversell_limit') }}" placeholder="e.g. 100"
