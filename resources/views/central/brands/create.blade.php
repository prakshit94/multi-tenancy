...
@section('content')
    <div class="max-w-2xl mx-auto space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold font-heading tracking-tight text-foreground">Add Brand</h1>
                <p class="text-muted-foreground text-sm">Create a new brand.</p>
            </div>
        </div>

        <!-- Form Card -->
        <div class="rounded-xl border border-border/50 bg-card/50 backdrop-blur-sm shadow-sm overflow-hidden p-6">
            <form action="{{ route('central.brands.store') }}" method="POST" class="space-y-6"
                x-data="{ name: '', slug: '' }">
                @csrf
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="meta_description" rows="3"
                        ...
                        placeholder="Short description for SEO..."></textarea>
                </div>
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <input type="checkbox" name="is_active" value="1" id="is_active"
                        class="h-4 w-4 rounded border-primary text-primary shadow focus:ring-primary" checked>
                    <label for="is_active"
                ...
                <div class="pt-4 flex justify-end gap-3">
                    ...
                    <x-ui.button type="submit">Create Brand</x-ui.button>
                </div>
            </form>
        </div>
    </div>
