    ...
    <div id="categories-page-wrapper" class="flex flex-1 flex-col space-y-8 p-8 animate-in fade-in duration-500">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
            ...
            <div class="flex items-center p-1 bg-muted/50 rounded-xl border border-border/50 backdrop-blur-sm">
                <a href="{{ route('central.categories.index') }}"
                ...
                <a href="{{ route('central.categories.index', ['status' => 'active']) }}"
        ...
        <div id="categories-table-container" x-data="{ selected: [] }">
            <div class="flex flex-col sm:flex-row items-center justify-between gap-4 p-1.5 rounded-2xl">
                ...
                <a href="{{ route('central.categories.create') }}"
                            ...
                            @forelse($categories as $category)
                                <tr
                                    ...
                                    <td class="p-6 align-middle">
                                        <div class="flex items-center gap-3">
                                            <div
                                                class="h-10 w-10 rounded-xl bg-muted flex items-center justify-center overflow-hidden border border-border/50 shadow-sm group-hover:scale-105 transition-transform duration-300">
                                                <img src="{{ $category->image_url }}" alt="{{ $category->name }}"
                                                    class="h-full w-full object-cover">
                                            </div>
                                            <div class="flex flex-col space-y-0.5">
                                                <span
                                                    class="font-semibold text-foreground text-sm tracking-tight">{{ $category->name }}</span>
                                                <span
                                                    class="text-xs text-muted-foreground font-mono">{{ $category->slug }}</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="p-6 align-middle">
                                        ...
                                        @else
                                            <span
                                                class="inline-flex items-center gap-1.5 rounded-lg border border-border bg-muted/30 px-2.5 py-1 text-xs font-medium text-muted-foreground/60 italic">
                                                Root Category
                                            </span>
                                        @endif
                                    </td>
                                        ...
                                        <div class="relative flex justify-end" x-data="{ open: false }"
                                            ...
                                            <div x-show="open"
                                                ...
                                                <div
                                                    ...
                                                    Manage</div>
                                                <a href="{{ route('central.categories.edit', $category) }}"
                                                ...
                                                <form action="{{ route('central.categories.destroy', $category) }}"
                ...
                @if($categories->hasPages())
                    <div
                        ...
                        <div class="text-xs text-muted-foreground px-2">Page <span
                                class="font-medium text-foreground">{{ $categories->currentPage() }}</span> of <span
                                class="font-medium">{{ $categories->lastPage() }}</span></div>
