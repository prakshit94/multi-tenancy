...
@section('content')
    <div class="max-w-2xl mx-auto space-y-6">
        ...
        <div class="rounded-xl border border-border/50 bg-card/50 backdrop-blur-sm shadow-sm overflow-hidden p-6">
            <form action="{{ route('central.categories.store') }}" method="POST" enctype="multipart/form-data"
                class="space-y-6" x-data="{ name: '', slug: '' }">
                @csrf
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="description" rows="3"
                        ...
                        placeholder="Short description for SEO and catalog display..."></textarea>
                </div>
                ...
                <div class="pt-4 flex justify-end gap-3">
                    <x-ui.button type="button" variant="outline"
                        href="{{ route('central.categories.index') }}">Cancel</x-ui.button>
